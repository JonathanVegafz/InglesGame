...
function Normal({ setInterface }) {
    ...
    const [buenoInitive, setBuenobuenoInitive] = useState(false);
    ...
    const hanlerVerificarRespuesta = () => {
        ...
        if (respuestaInitive.toLowerCase() === verboActual.infinitive.toLowerCase()) {
            setBuenobuenoInitive(true);
            contadorBuenasLocal++;
        }else{
            setBuenobuenoInitive(false);
            console.log("Respuesta incorrecta: " + respuestaInitive + " -> " + verboActual.infinitive);
            setRespuestaInitive(respuestaInitive + " -> " + verboActual.infinitive );
        } 

        if(contadorBuenasLocal == 3){
    ...
    return (
        ...
        <Paper sx={{ padding: 3, maxWidth: 600, margin: "auto" }}>
            ...
            <Typography variant="h6" align="center" sx={{ marginTop: 1, marginBottom: 2 }}> Verbo en {verboActual.selectedTypeVerbo}: <strong>{verboActual.selectedVerbo}</strong></Typography>
            {
                verboActual.selectedTypeVerbo != "Past Simple" ?
                <TextField
            ...
            {
                verboActual.selectedTypeVerbo != "Past Participle" ?
                <TextField
            ...
            {
                verboActual.selectedTypeVerbo != "Spanish" ?
                <TextField
            ...
            {
                verboActual.selectedTypeVerbo != "Infinitive" ?
                <TextField
