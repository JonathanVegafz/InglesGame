...
function Facil({ setInterface }) {
    ...
    const hanlerVerificarRespuesta = () => {
        ...
        if(contadorBuenasLocal == 3){
            ...
            if(contadorBuenas + 1 == cantidadVerbos){
    ...
    return (
        ...
        <Paper sx={{ padding: 3, maxWidth: 600, margin: "auto" }}>
            ...
            <Typography variant="h6" align="center" sx={{ marginTop: 1, marginBottom: 2 }}> Verbo en infinitivo: <strong>{verboActual.infinitive}</strong> </Typography>
